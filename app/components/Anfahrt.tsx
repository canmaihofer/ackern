    ...
    <div className="flex flex-col md:flex-row items-center p-6 ">
      <div className="md:w-1/2 text-center md:text-left" id="anfahrt">
        ...
        <p className="text-gray-300">
          Unser Festivalgelände befindet sich auf dem Feriengelände der
          schnellst Stuten Europas. Einmal durch die Anfahrt bis zur grünen
          Oase. Danach der Beschilderung folgen.
        </p>
        <p>Für den Findungsprozess: Wethener Straße 83 A</p>
      </div>
